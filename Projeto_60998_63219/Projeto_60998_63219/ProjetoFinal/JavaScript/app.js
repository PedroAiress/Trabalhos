...
//Controls
{
    ...
    document.addEventListener('keydown',ev=>{
        switch(ev.keyCode)
        {
            ...
            case 49: //1
                    objetoImportado2.position.x += 50;
                break;
            ...
            case 51: //3
                objetoImportado2.position.z += 50;
...
function Create_RelvaPlane()
{
    geometry = new THREE.PlaneGeometry(100000, 100000);

    var FloorRelvaTexture = loader.load('./Textures/Relva.jpg');
    FloorRelvaTexture.wrapS = FloorRelvaTexture.wrapT = THREE.RepeatWrapping;
    FloorRelvaTexture.repeat.set(250, 250);
    FloorRelvaTexture.anisotropy = 16;
    FloorRelvaTexture.encoding = THREE.sRGBEncoding;
    material = new THREE.MeshPhongMaterial({map: FloorRelvaTexture});
    material.side = THREE.DoubleSide;
    enviornment = new THREE.Mesh(geometry, material); 

    enviornment.name = "Relva";
...
function Create_Stage()
{
    ...
    var Texture3 = Textureloader3.load('./Textures/Neon.jpg')
...
function Publico()
{
    importer.load('./Objects/SambaDancing.fbx', function(object) {
        ...
        object.position.set(5000, 0, -20000);

        objetoImportado2 = object;

        //light.lookAt(objetoImportado2.position);
        //scene.add(light);
    }); 
}
/* function Publico2()
{
    importer.load('./Objects/SambaDancing.fbx', function(object) {
        ...
        object.rotation.y = -Math.PI/2;
        object.position.set(6000, 0000, -17000);
...
function Publico3()
{
    importer.load('./Objects/SambaDancing.fbx', function(object) {
        ...
        object.rotation.y = -Math.PI/2;
        object.position.set(4000, 0, -23000);
...
function Publico4()
{
    importer.load('./Objects/SambaDancing.fbx', function(object) {
        ...
        object.rotation.y = -Math.PI/2;
        object.position.set(2500,  0, -20000);
...
function Publico5()
{
    importer.load('./Objects/SambaDancing.fbx', function(object) {
        ...
        object.rotation.y = -Math.PI/2;
        object.position.set(2500, 0, -16000);
...
function Publico6()
{
    importer.load('./Objects/SambaDancing.fbx', function(object) {
        ...
        object.rotation.y = -Math.PI/2;
        object.position.set(7500, 0, -21000);
